...
> **Kubernetes environment also available** — see [../k8s/README.md](../k8s/README.md) for a Helm-based setup where the upgrade is handled by a rolling StatefulSet restart rather than a manual script.
